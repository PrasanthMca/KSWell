...
private static String OUTPUT_PATH;
    ...
    private void initComponents() {
        ...
        jButton2.setText("Select Output Folder");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        if(!CSV_PATH.equalsIgnoreCase("") && !OUTPUT_PATH.equalsIgnoreCase("") )
        {
        new GetTextFile(CSV_PATH,OUTPUT_PATH);
        }
    ...
    public static void main(String args[]) {
      ...
      public boolean validateFile(String CSVFile )
      {
          if(CSVFile.contains(".csv") || CSVFile.contains(".CSV"))
              return true;
          else
              return false;
      }
